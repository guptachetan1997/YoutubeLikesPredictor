...
def getChannelDetails(channelId):
	...
	url = "https://www.youtube.com/channel/{}/about".format(channelId)
	headers={
	...
	try:
		stats = soup.find('div', attrs={"class":"about-stats"}).findAll('b')
		subscribers = cleanNumber(stats[0].text)
		totalViews = cleanNumber(stats[1].text)
		return (subscribers, totalViews)
	except AttributeError:
		print("Attribute Error for {} .".format(channelId))
		return (0, 0)
	except IndexError:
		print("Index Error for {} .".format(channelId))
		return (0, 0)



def main():
	print(getChannelDetails("UCJ0uqCI0Vqr2Rrt1HseGirg"))
